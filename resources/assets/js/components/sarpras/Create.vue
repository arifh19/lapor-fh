    ...
    <div>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Tambah Sarpras</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form enctype="multipart/form-data" role="form" @submit.prevent="store({lokasi_id,nama, kode, spesifikasi, unit_id, kondisi})">
                            <div class="card-body">
